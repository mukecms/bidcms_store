...
/**
 ...
 $Id: ftp.class.php 2010-08-24 10:42 $
 * 仿写CodeIgniter的FTP类
 * FTP基本操作：
 * 1) 登陆; 			connect
 * 2) 当前目录文件列表;  filelist
...
class Ftp {
	...
	private function _settype($ext) {
		$text_type = array ('jpg','png','gif','png','bmp');
	...
	private function _error($msg) {
		return @file_put_contents('ftp_err.log', "date[".date("Y-m-d H:i:s")."]-hostname[".$this->hostname."]-msg[".$msg."]\n", FILE_APPEND);
	}
}
