...
<div class="container">
    <div class="inner clearfix">
        ...
        <div class="content-right">
            <h1 class="content-right-title">优惠券统计<a class="gicon-info-sign gicon_linkother" href="javascript:;" target="_blank"></a></h1>
    ...
    <table class="wxtables data">
        ...
        <thead>
            <tr>
                <td colspan="2" class="left" style="font-size:14px;">数据统计</td>
            </tr>
        </thead>
        <tbody id="tBodyGetCouponCount">
            <tr>
                <td>加载中...</td>
            </tr>
        </tbody>
    ...
    <div class="chartWrap mgt40">
        <div class="chartTitle clearfix">
            <span class="c-text fl">发放优惠券<a class="gicon-info-sign gicon_linkother" href="javascript:;" target="_blank"></a></span>
            ...
            <div class="cb-contain">
                <div class="cbc-live clearfix">
                    <div class="cbc-live-width cbc-live-org fl">
                        <span><b id="time_text_1">近30天</b>发放的优惠券</span>
                        <strong id="ffyhj_n">0</strong>
                    </div>
                   <!--  <div class="cbc-live-width cbc-live-blue fl">
                        <span>近6个月使用的优惠券</span>
                        <strong id="syyhj_n">0</strong>
                    </div> -->
                </div>
                <div class="table-loading" id="loading_chart_ffyhj">
                    <div class="progress">
                        <div class="progress-bar progress-bar-warning progress-bar-striped active" style="width: 100%;"></div>
                    </div>
                </div>
                <div id="chart_ffyhj" class="mgt10 txtCenter j-chartPanel" style="display:none;width:920px; height:200px;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="chartWrap mgt40">
        <div class="chartTitle clearfix">
            <span class="c-text fl">使用优惠券<a class="gicon-info-sign gicon_linkother" href="javascript:;" target="_blank"></a></span>
            <div class="search-box">
               <div class="form-inline clearfix">
                    <div class="t-list fl">
                        <label class="tbs-txt" style="width:80px; font-weight:normal;">筛选日期：</label>
        ...
        <div class="chartBox chartBox-bdr chartBox-fullcolor mgt5">
            ...
            <div class="cb-contain">
                <div class="cbc-live clearfix">
                    <div class="cbc-live-width cbc-live-blue fl">
                        <span><b id="time_text_2">近30天</b>使用的优惠券</span>
                        <strong id="syyhj_n">0</strong>
                    </div>
                </div>
                <div class="table-loading" id="loading_chart_syyhj">
                    <div class="progress">
                        <div class="progress-bar progress-bar-warning progress-bar-striped active" style="width: 100%;"></div>
                    </div>
                </div>
                <div id="chart_syyhj" class="mgt10 txtCenter j-chartPanel" style="display:none;width:920px; height:200px;"></div>
            </div>
        </div>
    </div>
...
<script src="<?php echo SITE_ROOT;?>statics/js/dist/Statistics/coupon_charts.js"></script>
