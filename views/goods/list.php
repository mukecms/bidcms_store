...
<div class="container">
    ...
    <a href="http://shop.bidcms.com/plugins/taobao" target="_blank" class="btn btn-danger">淘宝联盟</a>
    <form action="" method="post">
        ...
        <div class="tabs clearfix mgt10">
            <a href="index.php?con=goods&staus=1" class="active tabs_a fl">出售中(1)</a>
            <a href="index.php?con=goods&staus=1" class=" tabs_a fl">仓库中(1)</a>
            <a href="index.php?con=goods&staus=1" class=" tabs_a fl">已售罄(1)</a>
            <a href="index.php?con=goods&staus=1" class=" tabs_a fl">警戒(1)</a>
        </div>
           ...
           <colgroup>
            ...
            <thead>
                <tr class="po_list">
                    ...
                    <td>创建时间
                      <span>
                            <a href="#" class="up "><b></b></a>
                            <a></a>
                            <a href="#" class="down "><b></b></a>
                        </span>
                    </td>
                    <td>操作<span></span></td>
                </tr>
            ...
            <tbody>
                ...
                <tr id="list<?php echo $item['id'];?>">
                    ...
                    <td>
                        <div class="goodswrap">
                            <a href="<?php echo API_STORE;?>m.php?con=item&shopid=<?php echo $item['shop_id'];?>&id=<?php echo $item['id'];?>" class="block" target="_blank" title="<?php echo $item['title'];?>">
                                <div class="table-item-img"><img src="<?php echo $item['thumb'];?>" alt=""></div>
                            </a>
                        </div>
                    </td>
                    <td>
                        <div class="goodswrap">
                            <a href="<?php echo API_STORE;?>m.php?con=item&shopid=<?php echo $item['shop_id'];?>&id=<?php echo $item['id'];?>" class="block" target="_blank" title="<?php echo $item['title'];?>">
                                <div class="table-item-info" style="width:100%;">
                                    ...
                                    <span class="price">&yen;<?php echo $item['price'];?></span>
                                </div>
                            </a>

                        </div>
                        <div class="stockwrap">
                            <span>库存：<?php echo $item['num'];?></span>
                        </div>
                    ...
                    <td>
                    <a href="index.php?con=goods&act=add_step2&id=<?php echo $item['id'];?>" class="btn btn-mini btn-primary width" title="修改">编辑</a>
