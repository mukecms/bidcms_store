...
<head>
    ...
    <title>paypal收款账号 - Bidcms开源电商</title>
...
<div class="container">
    <div class="inner clearfix">
        ...
        <div class="content-right">
            <h1 class="content-right-title">paypal收款账号<a class="gicon-info-sign gicon_linkother" href="//www.wifenxiao.com/Index/help_show/lm/help/id/189.html" target="_blank"></a></h1>


    <div class="alert alert-info disable-del"><h4>提示</h4>开启paypal支付后，可以添加商品美元价格，会员可以使用美元购买商品。</div>

    <div class="sysPanel">
        <div class="sysPanel-con">
            <div class="sysPanel-title">功能开关</div>
            <div class="sysPanel-tip">开启后，结算时可以使用paypal支付</div>
        </div>
        <div class="vir-chkb j-vir-chkb">
            ...
            <input type="radio" name="is_paypal" class="ip-checkbox j-vir-checkbox" <?php echo $shopinfo['is_paypal']==1?'checked':'';?>>
        </div>
    </div>
    ...
    <div class="sysPanel">
        <div class="sysPanel-con">
            ...
            <div class="sysPanel-tip">是否设置paypal为默认支付方式</div>
        </div>
        <div class="vir-chkb j-vir-chkb">
            <div class="vir-chkb-actions clearfix">
            ...
            <input type="radio" name="default_pay_type" class="ip-checkbox j-vir-checkbox" data-enableval="4" data-disableval="0" <?php echo $shopinfo['default_pay_type']==4?'checked':'';?>>
        </div>
    </div>
    ...
    <div class="sysPanel">
        <div class="formitems">
            ...
            <div class="form-controls">
                <a href="https://www.paypal.com/c2/webapps/mpp/get-started" class="btn btn-warning btn-small" target="_blank">去paypal</a>
            </div>
        </div>
        <div class="formitems">
            <label class="fi-name"><span class="colorRed">*</span>paypal账号：</label>
            <div class="form-controls">
                <input type="text" class="input xlarge j-account j-text-autosave" name="paypal_account" value="<?php echo $shopinfo['paypal_account'];?>">
                <span class="fi-help-text"></span>
            </div>
        </div>
        <div class="formitems inline">
            <label class="fi-name"><span class="colorRed">*</span>货币类型：</label>
            <div class="form-controls">
                <select name="paypal_currency" class="select j-select-autosave">
                    <option value="USD" <?php echo $shopinfo['paypal_currency']=='USD'?'selected':'';?>>美元</option>
					<option value="CAD" <?php echo $shopinfo['paypal_currency']=='CAD'?'selected':'';?>>加元</option>
				</select>
                <span class="fi-help-text"></span>
            </div>
        </div>
